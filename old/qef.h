...
namespace svd
{
    ...
    {
    public:
        Real ata_00, ata_01, ata_02, ata_11, ata_12, ata_22;
        Real atb_x, atb_y, atb_z;
        Real btb;
        Real massPoint_x, massPoint_y, massPoint_z;
        int numPoints;

        QefData();

        QefData(const Real ata_00, const Real ata_01,
        ...
        void set(const Real ata_00, const Real ata_01,
                 const Real ata_02, const Real ata_11, const Real ata_12,
                 const Real ata_22, const Real atb_x, const Real atb_y,
                 const Real atb_z, const Real btb, const Real massPoint_x,
                 const Real massPoint_y, const Real massPoint_z,
        ...
        QefData operator*(const Real &number);
    ...
    public:
        ...
        void add(const Real px, const Real py, const Real pz,
                 Real nx, Real ny, Real nz) ;
        void add(const Vec3 &p, const Vec3 &n);
        void add(const QefData &rhs) ;
        QefData getData() ;
        Real getError();
        Real getError(const Vec3 &pos);
        void reset();
        Real solve(Vec3 &outx, const Real svd_tol,
